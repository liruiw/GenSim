...
import json
import subprocess
from gensim.utils import set_gpt_model, clear_messages, format_finetune_prompt_codeonly
...
for task_file in base_task_codes:
    ...
    prompt = format_finetune_prompt_codeonly(task_name, prompt_file='finetune_instructions_prompt_codeonly_llamma.txt')
...
df.to_csv("prompts/finetune_data_codellama.csv",index=False)
print("======================================")
